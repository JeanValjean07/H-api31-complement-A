...
import com.example.study3.NotiService.Companion.ACTION_NOTIFICATION_RECEIVED
...
class NotiControl: AppCompatActivity(), ReceiverCallback {
    ...
    val NotiList = mutableStateListOf<MutableList<String>>()
    var count=0
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.noticontrol)) { v, insets ->
        ...
        buttonT2.setOnClickListener {
            ...
            if (!isNotificationListenerEnabled) {
                Toast.makeText(this, "通知监听权限未开启", Toast.LENGTH_SHORT).show()
                ...
                if (areNotificationsEnabled) {
                    ...
                    Toast.makeText(this, "需要发送通知来触发监听器的回调函数,请允许本APP通知权限", Toast.LENGTH_SHORT).show()
        ...
        button2.setOnClickListener {
            Toast.makeText(this, "该功能完善中", Toast.LENGTH_SHORT).show()
            return@setOnClickListener
